...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_h,		spawn,	        SHCMD(TERMINAL " htop") },
	...
	{ MODKEY|ShiftMask,		XK_m,           spawn,		SHCMD("displayselect") },
